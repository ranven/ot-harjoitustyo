...
class ProjectListView:
    ...
    def _initialize_project(self, project):
        ...
        project_created_at = ttk.Label(
            master=project_frame, text=project.created_at)
...
class ProjectView:
    ...
    def _initialize_project_list(self):
        ...
        self._project_list_view = ProjectListView(
            self._project_list_frame, projects)
    ...
    def _initialize_footer(self):
        ...
        create_project_submit = ttk.Button(
            master=self._frame, text="Add project", command=self._handle_add_project)
